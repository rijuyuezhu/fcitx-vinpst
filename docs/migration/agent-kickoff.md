...
- Packaging now deterministically covers explicit handoff and automatic executable-replacement restart for daemons started by the new systemd unit. First-upgrade/direct-activation/removal handling, production publication, incompatible-state rollback, and the deferred Rust GUI remain; see [`../architecture/packaging-contract.md`](../architecture/packaging-contract.md) and [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
