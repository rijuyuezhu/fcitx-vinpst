...
The active priority is **M7: Rust management GUI**. Broaden resource-specific error taxonomy, complete accessibility/keyboard/input-method/clipboard review on top of the complete deterministic English/zh_CN presentation layer, and obtain real Wayland/X11 interaction proof for the portal, desktop opener, startup notification card, install/recovery panels, and core forms. Treat new packaging and desktop breadth as deferred expansion unless a regression, blocker, or explicit user request requires it.
