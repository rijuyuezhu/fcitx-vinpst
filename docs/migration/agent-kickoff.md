...
- Biggest blockers: real Fcitx -> PipeWire -> native ASR -> partial/preedit -> commit proof, remaining sherpa families, frontend labels/i18n details, packaging, and remote services.
...
3. Prove searchable scene/ASR menus, persistent trigger/paging keys, and Tap/Hold/Both timing live, then improve labels/i18n details.
