...
4. SenseVoice, Paraformer, Qwen3 ASR, Moonshine v1, transducer, and Zipformer2 CTC mappings are implemented; Dolphin and other registry-compatible families still need runtime support. Paraformer Small and Moonshine Tiny int8 are registry-installed and real-WAV proven.
