...
6. Fcitx UX parity is incomplete: the minimal scene menu and installed-model-aware ASR menu are C++/D-Bus tested but not live-desktop proven; frontend config UI, tap/hold/both behavior, legacy search, richer menu labels/i18n, and rich notifications remain missing or partial.
