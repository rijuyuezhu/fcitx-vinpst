...
1. **Application breadth:** GTK3, GTK4, Qt6, Chromium, GNOME Text Editor, and kitty normal/command paths are live-proven, and Chromium renderers are sandbox-attested; additional terminals, sandbox packaging formats/applications, and repeated long-session behavior remain.
