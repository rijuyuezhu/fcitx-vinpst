...
| Audio | Typed PCM, processing, mock/file sources, capture-before-session ordering with deterministic rollback, optional PipeWire recorder and diagnostics | PipeWire stream reuse/idle grace and real capture proof |
