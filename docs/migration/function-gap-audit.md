...
| Generic native user install | Temporary-HOME D-Bus auto-activation, installed owner, runtime bundle, exact online recognition, and C++ FrontendBridge Commit proven |
