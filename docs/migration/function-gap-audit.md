...
1. **Application breadth:** GTK3, GTK4, Qt6, and Chromium normal/command paths are live-proven, but additional editors, terminals, sandboxed applications, and repeated long-session behavior remain.
