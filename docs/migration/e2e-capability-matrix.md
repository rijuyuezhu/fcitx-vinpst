...
- remaining Rust `vinput-gui` LLM connectivity testing/selection, hotword lifecycle, broader error taxonomy, command-mode, localization/accessibility, and live interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
