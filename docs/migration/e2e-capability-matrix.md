...
- remaining Rust `vinput-gui` plain-thread action migration, broader error taxonomy, non-text keyboard/accessibility-tree support, X11, and live portal/opener/notification/install/mutation proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
