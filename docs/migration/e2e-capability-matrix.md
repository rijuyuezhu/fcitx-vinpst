...
- remaining Rust `vinput-gui` broader error taxonomy, non-text keyboard/accessibility-tree support, X11, and live portal/opener/notification/install/mutation result proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
