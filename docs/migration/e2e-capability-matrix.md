...
- remaining Rust `vinput-gui` broader error taxonomy, LLM/adapter-form and install localization, accessibility, and live interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
