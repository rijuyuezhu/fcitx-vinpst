...
- remaining Rust `vinput-gui` broader error taxonomy, assistive-technology accessibility-tree support, X11, and live portal/opener/notification/install/mutation result proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
