...
3. Prove searchable scene/ASR menus, persistent trigger/paging keys, and Tap/Hold/Both timing in a real Fcitx session, then improve remaining labels/i18n details.
