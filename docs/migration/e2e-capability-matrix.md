...
- remaining Rust `vinput-gui` broader error taxonomy, accessibility/keyboard/input-method/clipboard review, and live bilingual interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
