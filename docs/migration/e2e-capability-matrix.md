...
hotword get/set/clear/edit; scene list/ls/add/edit/use/remove; llm list/ls/add/edit/remove; adapter list/ls/add/remove
device list/use
...
- live registry install/use/remove exists for model flow, provider list/use exists, but remaining provider UX polish plus LLM test plus adapter edit/runtime commands are still missing; device list/use exists;
...
- `vinput scene list/ls/add/edit/use/remove; llm list/ls/add/edit/remove; adapter list/ls/add/remove` inspects and selects configured recognition scenes. **Done for dry-run/output/in-place writes, backup/validation guards, JSON/text output, and README/just smoke.**
