...
- remaining Rust `vinput-gui` broader error taxonomy, scene/form/install localization, accessibility, and live interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
