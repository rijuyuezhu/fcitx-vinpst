...
- remaining Rust `vinput-gui` broader error taxonomy, Resources/LLM/form localization, accessibility, and live interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
