...
3. Prove the scene menu, installed-model ASR menu, persistent trigger/paging keys, and Tap/Hold/Both timing in a real Fcitx session, then add legacy menu search/i18n details.
