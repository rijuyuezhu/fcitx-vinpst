...
- remaining Rust `vinput-gui` broader error taxonomy, assistive-technology accessibility-tree support, and live install/recovery/mutation result proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
...
5. Advance live Flatpak desktop/Fcitx/PipeWire/host-systemd proof and publication policy, supported-distro RPM repository/live-scriptlet proof, remote live proof, and the remaining Rust GUI lifecycle/live-interaction work without regressing the retained evidence.
