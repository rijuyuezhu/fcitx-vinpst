...
- remaining Rust `vinput-gui` broader error taxonomy, install/progress/recovery localization, accessibility, and live interaction proof; see [`../architecture/gui-contract.md`](../architecture/gui-contract.md).
