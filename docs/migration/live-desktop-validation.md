...
VINPUT_LIVE_NATIVE_WAV=/path/to/validated-speech.wav \
  just ime-gtk4-repeat-virtual-source-live normal 3
VINPUT_LIVE_NATIVE_WAV=/path/to/validated-speech.wav \
  just ime-gtk4-repeat-virtual-source-live command 3
VINPUT_LIVE_NATIVE_WAV=/path/to/validated-speech.wav \
...
- GTK4 normal and command under `target/tmp/ime-gtk4-virtual-source-live`, with niri focus and `/dev/uinput` evidence, plus three-cycle same-window/same-daemon normal and command proof under `target/tmp/ime-gtk4-repeat-virtual-source-live`;
