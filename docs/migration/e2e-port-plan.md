...
- live localized searchable scene/installed-model ASR-menu, persisted registry-title, trigger/paging-key, Tap/Hold/Both, and local-notification proof; asynchronous daemon-notification forwarding;
