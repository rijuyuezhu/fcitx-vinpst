...
- Add representative live result proof for provider/adapter install-recovery and remaining GUI resource mutations; keep the completed private-registry model install/rendered-row/removal gate green.
