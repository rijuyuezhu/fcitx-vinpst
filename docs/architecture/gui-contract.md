...
- **Resources** lists and filters typed ASR providers and scenes, installs or updates live-registry ASR models by ID/short ID, scans managed installed models, removes inactive managed model directories, and exposes selectable secret-safe model/provider detail panels.
