...
3. richer model metadata and error details, plus reuse of the typed progress/cancellation framework for future provider, adapter, and script operations;
