...
gui_bin="${VINPST_GUI_X11_LIVE_BIN:-target/debug/vinpst-gui}"
out_dir="${VINPST_GUI_X11_LIVE_OUT_DIR:-target/tmp/gui-x11-interaction-live}"
key_sender="${VINPST_GUI_X11_LIVE_KEY_SENDER:-scripts/live/niri/probes/send-uinput-key.py}"
text_sender="${VINPST_GUI_X11_LIVE_TEXT_SENDER:-scripts/live/niri/probes/send-uinput-text.py}"
rime_im="${VINPST_GUI_X11_LIVE_RIME_IM:-rime}"
rime_input="${VINPST_GUI_X11_LIVE_RIME_INPUT:-ceshi}"
notification_url="${VINPST_GUI_X11_LIVE_NOTIFICATION_URL:-http://127.0.0.1:9/notification.json}"
