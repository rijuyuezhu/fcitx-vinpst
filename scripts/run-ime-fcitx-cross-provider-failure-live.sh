...
selection_probe="${repo_root}/scripts/fcitx-live-asr-selection-probe.py"
virtual_runner="${repo_root}/scripts/run-ime-fcitx-virtual-source-live.sh"
out_dir="${VINPUT_LIVE_CROSS_PROVIDER_FAILURE_OUT_DIR:-target/tmp/ime-fcitx-cross-provider-failure-live}"
