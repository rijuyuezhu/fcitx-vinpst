...
- loopback OpenAI-compatible ASR and text-provider servers, with optional fixed loopback ports for same-endpoint restart/CA-file replacement and controlled response padding for bounded-body gates;
