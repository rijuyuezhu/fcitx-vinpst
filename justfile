...
toolkit-probe-check:
    ...
    bash -n scripts/run-ime-chromium-native-live.sh scripts/run-ime-gtk4-native-live.sh scripts/run-ime-gnome-text-editor-live.sh scripts/run-ime-fcitx-virtual-source-live.sh
