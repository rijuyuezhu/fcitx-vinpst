...
fn audio_architecture_pins_pipewire_live_test_policy() {
    ...
    for required in [
        ...
        "VINPUT_TEST_PIPEWIRE_RECORD_MS",
        "VINPUT_TEST_PIPEWIRE_MIN_PEAK",
        "prints source, frame count, duration, peak amplitude, and first-buffer latency",
...
fn frontend_notification_live_gate_pins_real_fcitx_sender() {
    ...
    for required in [
        ...
        "fcitx5-vinput",
        "dialog-information",
        "VINPUT_LIVE_NOTIFICATION_EXPECTED_SUMMARY",
        "VINPUT_LIVE_NOTIFICATION_EXPECTED_BODY_PREFIX",
        "VINPUT_LIVE_NOTIFICATION_EXPECTED_BODY_SUFFIX",
        "notification summary was",
        "expected localized prefix",
        "expected localized suffix",
...
fn daemon_error_notification_live_gate_pins_failure_and_restore() {
    ...
    for required in [
        ...
        "dialog-error",
        "VINPUT_LIVE_ERROR_NOTIFICATION_EXPECTED_SUMMARY",
        "error notification summary was",
...
fn asr_cross_provider_failure_live_gate_pins_preservation_and_recovery() {
    ...
    for required in [
        ...
        "type\": \"remote",
        "ftp://127.0.0.1/unavailable",
        "unsupported remote ASR endpoint scheme",
        "--expect-reload-failure",
        "asr_backend_reload_failed",
        "dialog-information",
        "dialog-error",
        "VINPUT_LIVE_FAILURE_EXPECTED_NOTIFICATION_SUMMARY",
        "VINPUT_LIVE_FAILURE_EXPECTED_SWITCH_BODY_PREFIX",
        "VINPUT_LIVE_FAILURE_EXPECTED_SWITCH_BODY_SUFFIX",
        "expected one Fcitx switch notification",
        "ASR switch notification body did not match the expected locale",
        "timeout_ms\"] != 3000",
        "timeout_ms\"] != 5000",
        "previous_backend_preserved",
        "daemon_sender_verified",
        "info_fcitx_sender_verified",
        "error_fcitx_sender_verified",
        ...
        "Fcitx did not exit before addon configuration restoration",
