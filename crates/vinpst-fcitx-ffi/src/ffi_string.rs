...
pub struct VinpstFcitxStringView {
...
pub(crate) unsafe fn text_view_input<'a>(view: VinpstFcitxStringView) -> Option<&'a str> {
    // SAFETY: Forwarded from this function's caller contract.
    unsafe { text_input(view.data, view.len) }
}

/// Creates a borrowed C view over a Rust string.
pub(crate) fn string_view(value: &str) -> VinpstFcitxStringView {
