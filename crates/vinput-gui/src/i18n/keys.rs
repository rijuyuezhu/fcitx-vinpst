...
pub(crate) enum GuiText {
    ...
    RegistryProviderSelector,
    RegistryAdapterSelector,
    AsrProviderResource,
    TextAdapterResource,
...
impl GuiText {
    pub(super) const ALL: [Self; 281] = [
        ...
        Self::RegistryProviderSelector,
        Self::RegistryAdapterSelector,
        ...
        Self::EnterRegistryModelSelector,
        Self::RemovingModel,
