...
pub const DAEMON_SERVICE_NAME: &str = "vinput-daemon.service";
/// Environment override for the `systemctl` executable.
pub const SYSTEMCTL_ENV: &str = "VINPUT_DAEMON_SYSTEMCTL";
/// Environment override for the Flatpak host-command wrapper.
pub const FLATPAK_SPAWN_ENV: &str = "VINPUT_FLATPAK_SPAWN";
/// Environment override for Flatpak detection.
pub const FLATPAK_INFO_PATH_ENV: &str = "VINPUT_FLATPAK_INFO_PATH";
