...
use vinput_asr::{AsrError, AudioDeliveryMode, RecognitionEvent, RecognitionSession};
use vinput_audio::{AudioChunkCallback, PcmBuffer, PcmSpec};
...
fn audio_to_asr_error(error: &vinput_audio::AudioError) -> AsrError {
