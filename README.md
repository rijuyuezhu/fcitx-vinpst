...
The current development priority is the Rust management GUI: complete provider script editing, required environment-value entry, richer resource details and error recovery, signal-driven daemon reconciliation, command-mode integration, localization/accessibility, and real Wayland/X11 interaction proof. Existing desktop and packaging evidence must remain green, but new packaging expansion is deferred while this baseline advances.
