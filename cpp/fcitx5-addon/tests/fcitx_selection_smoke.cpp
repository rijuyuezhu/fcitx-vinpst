...
int main() {
  ...
  assert(SelectedTextWithPrimaryFallback(invalid, "").empty());
  assert(!SelectedTextDeletionRange(invalid).has_value());

  fcitx::SurroundingText forward;
  forward.setText("selected tail", 8, 0);
  assert(SelectedTextWithPrimaryFallback(forward, "fallback") == "selected");
  ...
  assert(SelectedTextWithPrimaryFallback(backward, "fallback") == "selected");
  ...
  assert(SelectedTextWithPrimaryFallback(middle_forward, "fallback") == "middle");
  ...
  assert(SelectedTextWithPrimaryFallback(middle_backward, "fallback") == "middle");
  ...
  assert(SelectedTextWithPrimaryFallback(utf8, "fallback") == "你好");
  ...
  assert(SelectedTextWithPrimaryFallback(backward_utf8, "fallback") == "你好");
  ...
  assert(SelectedTextWithPrimaryFallback(emoji_text, "fallback") == emoji);
  ...
  assert(SelectedTextWithPrimaryFallback(full_forward, "fallback") == "replace all");
  ...
  assert(SelectedTextWithPrimaryFallback(full_backward, "fallback") == "replace all");
